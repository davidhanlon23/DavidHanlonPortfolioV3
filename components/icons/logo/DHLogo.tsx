...
const DHLogo = ({
    ...
    return (
        <svg className={classes} fill="currentColor" viewBox="0 0 129 62" xmlns="http://www.w3.org/2000/svg">
        <g id="A" transform="translate(-222.000000, -171.000000)" fill="currentColor" fill-rule="nonzero">
